module.exports = {
  ...
  // i.e: "-exodusbot foo" will trigger the command "foo",
  //      whereas "ExodusBot foo" will do nothing at all.
  prefix:  "-eb",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "Mjk3ODY4NjgwNTMwNzU1NTg1.C8dRfw.R6noYBPFW6tCj3L14TGCg8jEThU",
